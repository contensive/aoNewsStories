            ...
            Try
                ...
                If cs.Open("story List", "storydate<=" & CP.Db.EncodeSQLDate(Now), "storydate  Desc") Then
                    ...
                    Do
                        ...
                        'End If
                        'blockLayout.SetInner(".art-title", "<p style=""padding-left:10px;"">" & brief & "</br>")
                        '
                ...
                returnHtml = Nustache.Core.Render.StringToString(My.Resources.NewsStoryHomePageNewsList, viewData)
