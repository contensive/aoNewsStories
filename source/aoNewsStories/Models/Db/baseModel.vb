    ...
    Public MustInherit Class baseModel
        ...
        Public Shared Function create(Of T As baseModel)(cp As CPBaseClass, recordGuid As String) As T
            ...
            Try
                ...
                Dim contentName As String = derivedContentName(instanceType)
                Dim cs As CPCSBaseClass = cp.CSNew()
                ' 201980218, added id sort in case a duplicate is created, always fall back to the first (and not show possible greeked in default)
